...
5. **무조건 작동하는 구글 링크 최소 8개**: 알 수 없는 가짜 링크는 절대 금지! 공식 사이트 주소를 모른다면 아래 양식을 무조건 따를 것.
   - 일반 정보 검색: <a href="https://www.google.com/search?q=정확한검색어" target="_blank">
   - 구글 지도: <a href="https://www.google.com/maps/search/정확한장소명" target="_blank">
